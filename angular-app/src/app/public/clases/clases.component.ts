...
export class ClasesComponent {
  ...
  ngOnInit(): void {
    ...
    this.http.get<any>('http://185.253.155.205/back/api/index.php/api/index').subscribe(data => {
  ...
  apuntarse(clase: any) {
    ...
    this.http.get<any>('http://185.253.155.205/back/api/index.php/api/plazaClase/' + clase).subscribe(data => {
      ...
      switch (clase) {
        case 1:
          ...
          this.http.post<any>('http://185.253.155.205/back/api/index.php/api/claseUsuario', { clase_usuario: clase_usuario }).subscribe(data => console.log(data));
